  ...
  return (
    <main className="review-page">
      ...
      <section className="review-shell">
        ...
        {faces.some((face) => face.autoCorrected || face.orientation) && <p className="orientation-notice">Cubix used the majority of the six center colors to correct uncertain stickers and align captured face rotations. You can still rotate or rescan a face if it does not match your cube.</p>}
        <div className="net">
